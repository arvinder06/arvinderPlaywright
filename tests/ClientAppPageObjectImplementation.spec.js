...
for (const data of dataSet) { //this is to run the same test for different set of data from json
    test.only(`TC001_ClientApp_Pages with Neetwrok call_RSA Shopping Website for product ${data.productName}`, async ({ page }) => { // The test name should be unique else playwright will throw error
